...
namespace fleet_management_backend.Migrations
{
    ...
    [Migration("20240610031336_Location model changed")]
    partial class Locationmodelchanged
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fleet_management_backend.Models.Domains.TripCertification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("TripCertificationTypeId")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("TripCertificationTypeId");

                    b.HasIndex("TripId");

                    b.ToTable("TripCertifications");
                });

            modelBuilder.Entity("fleet_management_backend.Models.Domains.TripCertificationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("TripCertificationTypes");
                });
            ...
            modelBuilder.Entity("fleet_management_backend.Models.Domains.TripCertification", b =>
                {
                    b.HasOne("fleet_management_backend.Models.Domains.TripCertificationType", "TripCertificationType")
                        .WithMany()
                        .HasForeignKey("TripCertificationTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("fleet_management_backend.Models.Domains.Trip", null)
                        .WithMany("TripCertifications")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TripCertificationType");
                });
            ...
            modelBuilder.Entity("fleet_management_backend.Models.Domains.Trip", b =>
                {
                    b.Navigation("TripCertifications");
